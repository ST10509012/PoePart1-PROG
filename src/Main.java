void main() {
    ...
    System.out.println(" Enter your Username" + "(ensure that your username contains an underscore and is no more than five characters in length):");
    String username = scanner.nextLine();
    System.out.println(" Enter your Password" + "(ensure that the password contains at least eight characters, a capital letter, a number, and a spec):");
